    package com.atguigu.activemq.transport;
    ...
    public class JmsConsumer {
        ...
        // public static final String BROKER_URL = "nio://192.168.1.204:61615";
        public static final String BROKER_URL = "tcp://192.168.1.204:61615";
           ...
           consumer.setMessageListener(new MessageListener() {
                ...
                public void onMessage(Message message) {
                    if (message instanceof TextMessage) {
                        ...
                        try {
                            System.out.println("收到transport的消息：" + msg.getText());
